...
call s:h("SpecialKey",    {"fg": s:norm})
call s:h("NonText",       {"fg": s:medium_gray})
call s:h("Directory",     {"fg": s:light_blue})
call s:h("ErrorMsg",      {"fg": s:pink})
call s:h("IncSearch",     {"bg": s:pink, "fg": s:white})
call s:h("Search",        {"bg": s:lighter_gray, "fg": s:black})
...
call s:h("DiffText",      {"fg": s:orange, "bg": s:bg_very_subtle})
...
call s:h("TabLineSel",    {"fg": s:light_green, "bg": s:bg_subtle, "gui": "bold", "cterm": "bold"})
